...
import { Loader2, Code2, Play, ChevronDown, ChevronUp, FileCode, TreePine, AlertTriangle } from 'lucide-react'
import CodeMirror from '@uiw/react-codemirror'
import { javascript } from '@codemirror/lang-javascript'
import { oneDark } from '@codemirror/theme-one-dark'

export function Episode13() {
  const { theme } = useTheme()
  const [isDark, setIsDark] = useState(false)
  const [vm] = useState(() => new TinyVM())
  const [sourceCode, setSourceCode] = useState<string>(`// Example: Exception handling with try/catch
try {
    print 10;
    throw 42;
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground text-lg">
            Exception handling with try/catch, stack unwinding, and error tracing
          </p>
        </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Use try/catch blocks to handle exceptions and view stack traces
            </CardDescription>
          </CardHeader>
        ...
        {stackTrace && (
          <Card className="mb-6">
            ...
            <CardContent>
              <pre className="bg-muted p-4 rounded-md font-mono text-xs whitespace-pre-wrap">
                {stackTrace}
              </pre>
            </CardContent>
          </Card>
